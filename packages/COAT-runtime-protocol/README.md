...
Source-of-truth data contracts for the COAT Runtime.

This package owns:

- `COAT_runtime_protocol/schemas/*.json` — JSON Schemas (Draft 2020-12) for every cross-process object
- `COAT_runtime_protocol/openapi/runtime.yaml` — HTTP/JSON-RPC daemon API
- `COAT_runtime_protocol/envelopes.py` — pydantic models that mirror the schemas

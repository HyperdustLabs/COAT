...
L2 pure-logic layer of the OpenCOAT Runtime. No I/O, no external services — every
side-effecting concern is expressed as a [Port](opencoat_runtime_core/ports/)
...
├── runtime.py           # OpenCOATRuntime facade
...
```python
from opencoat_runtime_core.concern import (

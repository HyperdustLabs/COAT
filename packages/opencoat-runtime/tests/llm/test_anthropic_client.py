...
from opencoat_runtime_llm import AnthropicClientError, AnthropicLLMClient
...
class TestLazyExport:
    def test_top_level_lazy_import_resolves(self) -> None:
        # Sanity-check that ``from opencoat_runtime_llm import ...``
        ...
        assert opencoat_runtime_llm.AnthropicLLMClient is AnthropicLLMClient
        assert opencoat_runtime_llm.AnthropicClientError is AnthropicClientError

    def test_unknown_attribute_raises_attribute_error(self) -> None:
        import opencoat_runtime_llm

        with pytest.raises(AttributeError, match="NotARealClient"):
            _ = opencoat_runtime_llm.NotARealClient

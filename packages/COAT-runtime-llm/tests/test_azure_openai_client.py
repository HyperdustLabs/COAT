...
class TestLazyExport:
    def test_top_level_lazy_import_resolves(self) -> None:
        ...
        assert COAT_runtime_llm.AzureOpenAILLMClient is AzureOpenAILLMClient
        assert COAT_runtime_llm.AzureOpenAIClientError is AzureOpenAIClientError
    ...
    def test_round_trip_through_lazy_loader_is_subclass_of_openai(self) -> None:
        ...
        assert issubclass(
            COAT_runtime_llm.AzureOpenAILLMClient,
            COAT_runtime_llm.OpenAILLMClient,
        )

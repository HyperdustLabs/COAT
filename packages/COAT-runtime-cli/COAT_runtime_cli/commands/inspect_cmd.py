...
:mod:`COAT_runtime_core` — they don't depend on a running daemon. We
...
from COAT_runtime_core.pointcut import strategies as _strategies
...
def _inspect_pointcuts() -> int:
    """List the 12 pointcut strategies bundled with ``COAT_runtime_core``."""

...
def _daemon_status_line() -> str:
    ...
    from COAT_runtime_cli._http import resolve_endpoint
...
def _profile_and_host_plugins_line() -> str:
    profile = os.environ.get("COAT_PROFILE") or os.environ.get("COATR_PROFILE") or "default"
    try:
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="COATr",
        description="Open COAT Runtime CLI (COATr).",

...
| **M2** | Real LLM (OpenAI / Anthropic / Azure) + extractor + lifecycle | ✅ complete — `OpenAILLMClient` ([PR-7 / #7](https://github.com/HyperdustLabs/COAT/pull/7)), `AnthropicLLMClient` ([PR-8 / #9](https://github.com/HyperdustLabs/COAT/pull/9)), `AzureOpenAILLMClient` ([PR-9 / #11](https://github.com/HyperdustLabs/COAT/pull/11)), `ConcernExtractor` ([PR-10 / #12](https://github.com/HyperdustLabs/COAT/pull/12)), `ConcernLifecycleManager` ([PR-11 / #13](https://github.com/HyperdustLabs/COAT/pull/13)), `examples/02_coding_agent_demo` ([PR-12 / #14](https://github.com/HyperdustLabs/COAT/pull/14)) |
| **M3** | Persistence (sqlite + jsonl replay) | ✅ complete — `SqliteConcernStore` ([PR-13 / #15](https://github.com/HyperdustLabs/COAT/pull/15)), `SqliteDCNStore` ([PR-14 / #16](https://github.com/HyperdustLabs/COAT/pull/16)), JSONL replay ([PR-15 / #18](https://github.com/HyperdustLabs/COAT/pull/18)), `examples/03_persistent_agent_demo` ([PR-16 / #20](https://github.com/HyperdustLabs/COAT/pull/20)) |
| **M4** | Daemon + CLI + HTTP/JSON-RPC | ✅ complete — `build_runtime` ([PR-17 / #21](https://github.com/HyperdustLabs/COAT/pull/21)), in-proc JSON-RPC ([PR-18 / #22](https://github.com/HyperdustLabs/COAT/pull/22)), stdlib HTTP JSON-RPC ([PR-19 / #23](https://github.com/HyperdustLabs/COAT/pull/23)), daemon lifecycle ([PR-20 / #24](https://github.com/HyperdustLabs/COAT/pull/24)), `opencoat runtime up\|down\|status` ([PR-21 / #25](https://github.com/HyperdustLabs/COAT/pull/25)), `opencoat concern \| dcn \| inspect` ([PR-22 / #26](https://github.com/HyperdustLabs/COAT/pull/26)), `examples/06_long_running_daemon` ([PR-23 / #27](https://github.com/HyperdustLabs/COAT/pull/27)) |
| **M5** | OpenClaw host plugin | ✅ complete — event map ([#28](https://github.com/HyperdustLabs/COAT/pull/28)), injection + spans ([#29](https://github.com/HyperdustLabs/COAT/pull/29)), tool guard ([#30](https://github.com/HyperdustLabs/COAT/pull/30)), memory bridge + hooks ([#31](https://github.com/HyperdustLabs/COAT/pull/31)), `examples/04_openclaw_with_runtime` ([#32](https://github.com/HyperdustLabs/COAT/pull/32)) |

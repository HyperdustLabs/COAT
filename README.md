...
| **M5** | OpenClaw host plugin | 🚧 in progress — event map ([#28](https://github.com/HyperdustLabs/COAT/pull/28)), injection + spans ([#29](https://github.com/HyperdustLabs/COAT/pull/29)) |
